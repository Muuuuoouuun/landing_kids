...
import { FadeIn, StaggerContainer, StaggerItem, ScaleIn } from './motion';
  ...
  return (
    <section className="py-24 md:py-32 px-6 lg:px-12 xl:px-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image src="/images/bg/curriculum-bg.png" alt="" fill className="object-cover opacity-20" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <FadeIn delay={0.2}>
            <p className="text-[var(--warm-gray)] font-medium text-lg max-w-xl mx-auto">
        ...
        {/* Curriculum grid - Staggered */}
        <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-5 gap-5 mb-20" stagger={0.08}>
          {areas.map((area, i) => (
            <StaggerItem key={i}>
              <div
        ...
        {/* Advisory board */}
        <ScaleIn>
          <div className="bg-white rounded-2xl border-[3px] border-[var(--super-text)] p-8 md:p-12 shadow-[6px_6px_0px_0px_var(--super-text)]">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="md:w-2/3 flex flex-col sm:flex-row gap-6">
                {advisors.map((a, i) => (
                  <div key={i} className="flex-1 flex items-center gap-4 bg-[var(--cream)] p-4 rounded-xl border-2 border-[var(--super-text)]/20 hover:border-[var(--super-text)] hover:shadow-[3px_3px_0px_0px_var(--super-text)] transition-all duration-300">
